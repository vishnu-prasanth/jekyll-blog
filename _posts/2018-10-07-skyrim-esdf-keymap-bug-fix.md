...
Skyrim is one of the best games I've ever played, but the way the devs hard coded the menu keys is just game breaking for me and many others, maybe its their tight deadlines. In any case I haven't found an easy fix for this. What I have are some mods/workarounds.<br><br>
...
Not only the E key but also the F key as well which is used to Favorite items or for Finding locations in the world map.<br>

### Fix #1 - Skyrim Key Helper<br>
This mod is available from <a href="https://steamcommunity.com/sharedfiles/filedetails/?id=8639">cray-g's workshop</a>.<br>
...
After this fix the UI still displays the same way, for fixin that we need SKUI.<br>

### Fix #2 - SKUI

SKUI is a mod that improves the UI and it depends on SKSE to work.<b>
...
It still leaves the map and book UI displaying the wrong key. But since it doesn't interfere with the gameplay I'll ignore it for now.<br>